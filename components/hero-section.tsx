                        ...
                        <div className="mx-auto max-w-5xl px-6">
                            <div className="sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    delay={0.5}
                                    as="p"
                                    className="mt-5 max-w-2xl text-pretty text-md text-muted-foreground">
                                    An editor built around the way developers work.
                                    Write notes, code, and Markdown without breaking your flow.
                                </TextEffect>
